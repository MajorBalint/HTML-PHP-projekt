...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE Cars SET brand='$brand', model='$model', model_year='$model_year', price='$price' WHERE idCars='$id'";
...
$query = "SELECT * FROM Cars WHERE idCars='$id'";
...
if (mysqli_num_rows($result) == 1) {
    ...
    echo "Nem található autó az adatbázisban.";
    echo '<br><a href="admin.php">Vissza</a>';
    exit;
}
?>
...
<div class="container">
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="form-group">
            <label for="model" class="btn btn-light" style="background-color: #ffffff; margin: 0 auto;">Modell:</label>
            <input type="text" class="form-control" id="model" name="model" value="<?php echo $model; ?>" required>
        </div>
        <div class="form-group">
            <label for="model_year" class="btn btn-light" style="background-color: #ffffff; margin: 0 auto;">Gyártási év:</label>
            <input type="number" class="form-control" id="model_year" name="model_year" value="<?php echo $model_year; ?>" required>
        </div>
        <div class="form-group">
