...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE Extra SET type='$type', price='$price', weight='$weight', description='$description' WHERE idExtra='$id'";
...
$query = "SELECT * FROM Extra WHERE idExtra='$id'";
...
if (mysqli_num_rows($result) == 1) {
    ...
    echo "Nem található extra az adatbázisban.";
    echo '<br><a href="admin.php">Vissza</a>';
    exit;
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Extra szerkesztése</title>
...
<div class="container">
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="form-group">
            <label for="weight" class="btn btn-light" style="background-color: #ffffff; margin: 0 auto;">Súly:</label>
            <input type="text" class="form-control" id="weight" name="weight" value="<?php echo $weight; ?>">
        </div>
        <div class="form-group">
            <label for="description" class="btn btn-light" style="background-color: #ffffff; margin: 0 auto;">Leírás:</label>
