...
<div class="container">
    ...
    <form method="POST" action="edit_user.php?edit_user_id=<?php echo $_GET['edit_user_id']; ?>">
        ...
        <button onclick="window.location.href='user_role.php'" class="btn btn-primary">Vissza</button>
